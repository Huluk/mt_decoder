...
\begin{figure}
	...
	\begin{subfigure}{.45\linewidth}
		\includegraphics[scale=.45]{d1_speed_k.png}
		\caption{Decoding time for the basic decoder.}
	\end{subfigure}
	\hskip2em
	\begin{subfigure}{.45\linewidth}
		\includegraphics[scale=.45]{d1_speed_s.png}
		\caption{Decoding time for the basic decoder.}
	\end{subfigure}
	\hskip2em
	\begin{subfigure}{.45\linewidth}
		\includegraphics[scale=.45]{d2_speed_k.png}
		\caption{Decoding time for the decoder with reordering.}
	\end{subfigure}
	\hskip2em
	\begin{subfigure}{.45\linewidth}
		\includegraphics[scale=.45]{d2_speed_s.png}
		\caption{Increasing stack size, range [1-100].}
	\end{subfigure}
	\caption{Decoding time for the decoder with reordering.}
\end{figure}
